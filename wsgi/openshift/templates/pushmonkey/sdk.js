var PushMonkey = function(config) {
  ...
  pm.showDialog = function() {
    ...
    link.setAttribute("style", "display: block; background-color: "+pm.dialogButtonBackgroundColor+"; width: 50px; border-radius: 5px; margin: 15px auto 0 auto; padding: 5px;");
